<script lang="ts">
     ...
     * 
     * Sets loading state during the request and handles both success and error cases.
     * Updates the games array with fetched data or sets error message on failure.
     */
