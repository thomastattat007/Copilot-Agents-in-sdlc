...
class TestGamesRoutes(unittest.TestCase):
    ...
    def test_create_game_success(self) -> None:
        ...
        new_game_data = {
            ...
            "description": "Navigate through code reviews and merge conflicts",
            "publisher_id": 1,
            "category_id": 1,
            "star_rating": 4.8
        }
    ...
    def test_create_game_missing_data(self) -> None:
        """Test game creation with missing required data"""
        # Act
    ...
    def test_create_game_empty_data(self) -> None:
        """Test game creation with empty JSON object"""
        # Act
        response = self.client.post(
            self.GAMES_API_PATH,
            data=json.dumps({}),
    ...
    def test_create_game_invalid_publisher(self) -> None:
        ...
        invalid_data = {
            ...
            "description": "A game with an invalid publisher",
    ...
    def test_create_game_invalid_category(self) -> None:
        ...
        invalid_data = {
            ...
            "description": "A game with an invalid category",
            "publisher_id": 1,
    ...
    def test_update_game_empty_data(self) -> None:
    ...
    def test_update_game_invalid_publisher(self) -> None:
        """Test update with invalid publisher ID"""
        # Get an existing game ID
        games_response = self.client.get(self.GAMES_API_PATH)
        games = self._get_response_data(games_response)
        game_id = games[0]['id']
